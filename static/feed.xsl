<xsl:stylesheet
    ...
    </xsl:template>    <xsl:template match="atom:feed/atom:link[@rel='previous']">
        <a rel="previous">
            <xsl:attribute name="href">
